...
const homePage = {
  ...
  body: ``,
  bodySummary:
    "High-performance ecommerce store built with Next.js and powered by voice AI.",
  seo: {
    title: "STS Store",
    description:
      "High-performance ecommerce store built with Next.js and powered by voice AI.",
...
const aboutPage = {
  ...
  title: "About",
  handle: "about",
  body: `<div className="prose mx-auto max-w-6xl text-base leading-7 text-black prose-headings:mt-8 prose-headings:font-semibold prose-headings:tracking-wide prose-headings:text-black prose-h1:text-5xl prose-h2:text-4xl prose-h3:text-3xl prose-h4:text-2xl prose-h5:text-xl prose-h6:text-lg prose-a:text-black prose-a:underline hover:prose-a:text-neutral-300 prose-strong:text-black prose-ol:mt-8 prose-ol:list-decimal prose-ol:pl-6 prose-ul:mt-8 prose-ul:list-disc prose-ul:pl-6 dark:text-white dark:prose-headings:text-white dark:prose-a:text-white dark:prose-strong:text-white mb-8"><p>This website is a modern ecommerce store built with Next.js and powered by voice AI technology using ElevenLabs.</p>
<p>Key features include:</p>
<ul>
<li>Voice-powered shopping experience</li>
<li>Hands-free product search and navigation</li>
<li>Voice-activated cart management</li>
<li>Intelligent voice assistant for product recommendations</li>
<li>Seamless integration with ElevenLabs voice AI</li>
<li>Real-time product catalog</li>
<li>And more!</li>
</ul>
<p>This store leverages modern Next.js features including:</p>
<ul>
<li>Next.js App Router</li>
<li>Optimized for SEO using Next.js's Metadata</li>
<li>React Server Components (RSCs) and Suspense</li>
<li>Client-side state management with localStorage</li>
<li>Edge runtime</li>
<li>Next.js 15 caching paradigms</li>
<li>Styling with Tailwind CSS</li>
<li>Automatic light/dark mode based on system settings</li>
<li>Voice-first user experience</li>
<li>And more!</li>
</ul></div>`,
  bodySummary:
    "This website is built with Next.js and powered by voice AI technology.",
  seo: {
    title: "About",
    description:
      "This website is built with Next.js and powered by voice AI technology.",
